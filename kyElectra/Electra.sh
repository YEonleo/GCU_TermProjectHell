...
python test.py \
  ...
  --do_test \
  --entity_property_model_path '../../saved_result/kyElectra/gcu_ky1.pt' \
...
python test.py \
  --base_model kykim/electra-kor-base\
  --do_test \
  --entity_property_model_path '../../saved_result/kyElectra/gcu_ky2.pt' \
...
python test.py \
  --base_model kykim/electra-kor-base\
  --do_test \
  --entity_property_model_path '../../saved_result/kyElectra/gcu_ky3.pt' \
...
python test.py \
  --base_model kykim/electra-kor-base\
  --do_test \
  --entity_property_model_path '../../saved_result/kyElectra/gcu_ky4.pt' \
...
python test.py \
  --base_model kykim/electra-kor-base\
  --do_test \
  --entity_property_model_path '../../saved_result/kyElectra/gcu_ky5.pt' \
